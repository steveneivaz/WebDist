...
function add() {
    console.log('add()');
   	...
   	newcontact= contactArray[currentContactIndex];
	console.log(newcontact);
	document.getElementById("nameID").value = newcontact.preferredName;   
    document.getElementById("emailID").value = newcontact.email;   
    document.getElementById("cityID").value = newcontact.city;   
    document.getElementById("stateID").value = newcontact.state;
    document.getElementById("zipID").value = newcontact.zip;
}
...
function autocomplete(inp, getCityState) {
  var currentFocus;
