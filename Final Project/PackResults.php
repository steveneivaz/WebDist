...
try {
    $conn = new PDO("sqlsrv:server = tcp:dokkan.database.windows.net,1433; Database = dokkan", "steveneivaz", "{S134221963e}");
...
$connectionInfo = array("UID" => "steveneivaz", "pwd" => "{S123421963e}", "Database" => "dokkan", "LoginTimeout" => 30, "Encrypt" => 1, "TrustServerCertificate" => 0);
